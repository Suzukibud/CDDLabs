...
The \mbox{\hyperlink{classSemaphore}{Semaphore}} Signal function increments (s). if (s) $<$= 0, then the next blocked process/thread in the queue is dequeued and becomes unblocked \mbox{\Hypertarget{classSemaphore_a72aabebf026e3a8b1f3e4d0fa8ee1eda}\label{classSemaphore_a72aabebf026e3a8b1f3e4d0fa8ee1eda}} 
