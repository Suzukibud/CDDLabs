...
The \mbox{\hyperlink{classSemaphore}{Semaphore}} \mbox{\hyperlink{classSignal}{Signal}} function increments (s). if (s) $<$= 0, then the next blocked process/thread in the queue is dequeued and becomes unblocked \mbox{\Hypertarget{classSemaphore_a72aabebf026e3a8b1f3e4d0fa8ee1eda}\label{classSemaphore_a72aabebf026e3a8b1f3e4d0fa8ee1eda}} 
...
The \mbox{\hyperlink{classSemaphore}{Semaphore}} wait function is used to decrement the \mbox{\hyperlink{classSemaphore}{Semaphore}} integer (s). if (s) is now negative the current process is blocked and placed in a q. 
